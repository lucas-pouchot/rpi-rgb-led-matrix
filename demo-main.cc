...
static int usage(const char *progname) {
	...
	fprintf(stderr, "Options:\n"
		...
		"\t-C            : Custom display, composed out of -s per floor of (-c/-s)*-P\n"
		"\t-s <nb-panels>: nb panels per row for use of -C (default 4)\n"
		"\t-E <enter>    : Mode of linking panels, use for -C (default A1)\n"
		"\t                A is for 'zigzag' chain, B is for 'snake' chain \n"
		"\t                1 if start on top-left corner,    2 if start on top-right corner\n"
		"\t                3 if start on bottom-left corner, 4 if start on bottom-right corner\n"
		"\t                Example (PX : P for panel, X is the number of the panel, so P01 is the panel directly connected to the pi)\n"
		"\t                        A1 ->  - P1 - P2 - P3 - P4 -             - P4 - P3 - P2 - P1 -  <- A2\n"
		"\t                               ____________________|             |____________________\n"
		"\t                              |- P5 - P6 - P7 - P8                 P8 - P7 - P6 - P5 -|\n"
		"\n"
		"\t                               - P5 - P6 - P7 - P8                 P8 - P7 - P6 - P5 -\n"
		"\t                               |___________________              ____________________|\n"
		"\t                        A3 -> - P1 - P2 - P3 - P4 -|            |- P4 - P3 - P2 - P1 -  <- A4\n"
		"\n"
		"\t                        B1 ->  - P1 - P2 - P3 - P4 -             - P4 - P3 - P2 - P1 -  <- B2\n"
		"\t                                                   |             |\n"
		"\t                                 P8 - P7 - P6 - P5 -             - P5 - P6 - P7 - P8\n"
		"\n"
		"\t                                 P8 - P7 - P6 - P5 -             - P5 - P6 - P7 - P8\n"
		"\t                                                   |             |\n"
		"\t                        B3 ->  - P1 - P2 - P3 - P4 -             - P4 - P3 - P2 - P1 -  <- B4\n\n");
...
int main(int argc, char *argv[]) {
	...
	int opt;
	while ((opt = getopt(argc, argv, "dlD:t:r:P:c:p:b:m:LR:CE:s:")) != -1) {
		switch (opt) {
		case 'D':
			demo = atoi(optarg);
			break;
	...
	if (customDisplay) {
		transformer->AddTransformer(new MultipleRowChainedTransformer(rows, chain, parallel, sizeOfRow, enterMode, chainType, rotation));
	} else {
		if (large_display) {
